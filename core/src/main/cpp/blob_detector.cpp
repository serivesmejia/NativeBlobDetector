...
Java_com_github_serivesmejia_nativeblobdetector_NativeBlobDetector_nativeCreateBlobDetector(JNIEnv *env, jobject thiz, jdouble minArea, jdouble minCircularity, jdouble maxCircularity) {
...
Java_com_github_serivesmejia_nativeblobdetector_NativeBlobDetector_nativeDetectBlobs(JNIEnv *env, jobject thiz, jlong blob_det_ptr, jlong input_ptr, jlong output_ptr) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_github_serivesmejia_nativeblobdetector_NativeBlobDetector_nativeReleaseBlobDetector(JNIEnv *env, jobject thiz, jlong blob_det_ptr) {
